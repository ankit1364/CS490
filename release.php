...
if($ucid != '')
{
	if(isset($_POST['release']))
		...
		curl_setopt($ch,CURLOPT_URL,"http://web.njit.edu/~aps64/cs490/back/release.php");
		...
		<script> 
	alert('Grades has been released!!'); 
	window.location='release.php';
	</script>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"> <a href="http://web.njit.edu/~asp82/490/front/prof/release.php"> Release Grades </a></li>
	...
	<div class="container">
		...
		<div class="jumbotron text-center">
			...
			if($numquiz == 0)
			    ...
			    <table class="table table-hover profquiz " align="center">
					<thead>
						<tr>
							<th>select</td>
					...
					echo "<tr>";
						if(strtotime($edate) > strtotime($today) || $status == 'released')
						{
                ...
                <input type="submit" class="btn btn-success pull-center" name="release" value="Release Grades">
